...
public class BurstValueTest {
    ...
    public void testConstructors() {
        ...
        assertEquals("123456789", BurstValue.fromBurst("1.23456789 ALITA").toPlanck().toString());
        assertEquals("123456789", BurstValue.fromBurst(1.23456789).toPlanck().toString());
    ...
    public void testToString() {
        // Positive
        assertEquals("1 ALITA", BurstValue.fromBurst(1).toString());
        assertEquals("1 ALITA", BurstValue.fromBurst(1).toFormattedString());
        assertEquals("1", BurstValue.fromBurst(1).toUnformattedString());
        assertEquals("1 ALITA", BurstValue.fromBurst(1.00000001).toString());
        assertEquals("1 ALITA", BurstValue.fromBurst(1.00000001).toFormattedString());
        assertEquals("1.00000001", BurstValue.fromBurst(1.00000001).toUnformattedString());
        assertEquals("1.235 ALITA", BurstValue.fromPlanck(123456789).toString());
        // Negative
        assertEquals("-1 ALITA", BurstValue.fromBurst(-1).toString());
        assertEquals("-1 ALITA", BurstValue.fromBurst(-1).toFormattedString());
        assertEquals("-1", BurstValue.fromBurst(-1).toUnformattedString());
